...
c.execute('CREATE TABLE hashtags(tag text PRIMARY KEY not null, post_id bigint, location_slug text)')
...
for filename in itertools.chain(json_files, json_xz_files):
	...
	if (hashtags_string != None):
		...
		for tag in hashtags_list:
			print(tag)
			c.execute('INSERT INTO hashtags VALUES(?, ?, ?)', (tag, post_id, location_slug))
